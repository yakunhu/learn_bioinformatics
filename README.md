...
Unlike quickfire, exact full question prompts are generated by the tutor agent at session time from those stored objectives. For Python, full questions are sourced from Leetcode. 
